...
abstract: |
  This business plan covers the establishment of Serious Ben Entertainment as a multi-vertical creative studio that operates at the intersection of digital health, media, crafts, and adventure tourism for a global, English-speaking audience. The studio’s portfolio includes: (1) Serious Health Games (SaaS) with AI-supported coaching and assessment, (2) the Dating Show format "Love is Warm" and related YouTube media, (3) Kitenge Krafts — fabric-based handcrafted items inspired by Malawian design, (4) Malawi Wood Kraft — sustainably sourced wooden handcrafted items, (5) Hike-/Bike-/Rafting tours around the Monkey Bay plot featuring a real-world serious-game geocaching adventure titled "The Serious Curse of the Bloody Monkey", and (6) YouTube content documenting the Monkey Bay off-grid plot (current: wooden shed with compost toilet, shower and kitchen, summer hut, well, tents, dog house; planned: chicken house, second kitchen with bread oven) and everyday off-grid life.
...
**Founding:** Serious Ben Entertainment is a new multi-vertical studio serving a global, English-speaking audience with a portfolio spanning Serious Health Games (SaaS + AI), original media formats (the Dating Show "Love is Warm"), artisan crafts brands (Kitenge Krafts and Malawi Wood Kraft), adventure tourism and real-world serious games in Monkey Bay, and a YouTube channel showcasing the off-grid plot and creative studio life. Co-founded by Benjamin Gross (clinical, data-science and product expertise) and Phelire Chisi (Social Worker, Artist, Healer — the creative force behind the studio), the company blends clinical rigor, data/AI capability, cultural authorship and craft. Based in Lilongwe and Monkey Bay (Malawi), the studio serves worldwide audiences through the web platform [www.seriousbenentertainment.org](https://www.seriousbenentertainment.org), global creator channels, and e-commerce/booking integrations.
